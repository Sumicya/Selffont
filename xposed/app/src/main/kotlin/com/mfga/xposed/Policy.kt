...
object Policy {
    ...
    const val FAMILY = "Zen Maru Gothic"

    /** 与 tools/build.py 的主字体 Regular 安装名一致。 */
    const val FONT_PATH = "/system/fonts/Selffont-ZenMaruGothic-Regular.ttf"
    ...
    /**
     * 把 Zen Maru Gothic 前置为 Gecko 各 generic/language 的首选;回退链只前置不清空,
