...
android {
    ...
    // AGP 9 built-in Kotlin derives the Kotlin jvmTarget from
    // compileOptions.targetCompatibility (21) above, so no kotlinOptions {} or
    // kotlin { compilerOptions {} } block is needed.
